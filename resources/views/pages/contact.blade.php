...
<!-- title area start-->
  <div class="section_titles fix pt-100 pb-50" style="background-image: url({{asset('public/assets/img/contact.jpg')}});background-repeat: no-repeat;background-size: cover;background-position: center center;background-attachment: fixed;height: 300px;animation: 10s header_anim 8">
    		...
    		<div class="conatct-form-area">
    			...
    			<div class="col-xl-9">
						...
						<div class="col-lg-6 form-group pt-15">
						 ...
						 <div class="col-lg-12 form-group pt-15">
							<textarea name="" rows="8" id="" class="form-control" placeholder=" Write Your Message"></textarea>
						 </div>

						 <div class="col-lg-12 form-group pt-15" style="margin-bottom: 0">
								<button class="contact-btn" type="submit">Send Query</button>
						 </div>
